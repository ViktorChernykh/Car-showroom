...
extension Car {
    static func loadSample() -> [Car] {
        return [
            ...
            Car(name: "ЗИС-5В", url: "art.scnassets/ZIS-5B/З®С-5В.dae", characteristics: "Сытый полдник", rating: 7, timestamp: Date()),
            Car(name: "ZIS-16", url: "art.scnassets/ZIS-16/З®С-16.dae", characteristics: "Отличный ужин", rating: 9, timestamp: Date())
        ]
    }
}
